...
bool task6(bool var1, bool var2, bool var3, bool var4) { //functia verifica cu ajutorul a task6_checker corectitudinea fiecarui byte al mastii
	if(task6_checker(var1) && task6_checker(var2) && task6_checker(var2) && task6_checker(var3)){
		printf("-6 DA\n");
		return 1;
	}
	printf("-6 NU\n");
...
int main() {
	...
	var1 = task6_checker(MSK_1.a);
	var2 = task6_checker(MSK_1.b);
	var3 = task6_checker(MSK_1.c);
	var4 = task6_checker(MSK_1.d);
	task6_checker = task6(var1, var2, var3, var4); //verifica corectitutdinea fiecarui byte din MSK_1
